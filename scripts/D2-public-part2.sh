...
# Enable Argon Config
#pushd package
#svn co https://github.com/kenzok8/openwrt-packages/trunk/luci-app-argon-config
#popd
...
# Add ArmyGreen Theme
#pushd package
#git clone --depth=1 https://github.com/XXKDB/luci-theme-argon_armygreen.git
#popd
#echo 'CONFIG_PACKAGE_luci-theme-argon_armygreen=y' >> .config
...
echo "DISTRIB_REVISION='[V21.02.0-C]'" >> package/base-files/files/etc/openwrt_release
