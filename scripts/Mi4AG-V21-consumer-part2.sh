...
echo "DISTRIB_REVISION='[21.02.0-RC4-Consumer]'" >> package/base-files/files/etc/openwrt_release
...
# Remove Passwall Config
rm -r files/etc/config/passwall
rm -r files/etc/config/passwall_server
